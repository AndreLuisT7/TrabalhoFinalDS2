...
namespace BarberShopMVC.Controllers
{
    ...
    {
        private readonly BarberShopMVCContext _context;

        public BarbersController(BarberShopMVCContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name")] Barber barber)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name")] Barber barber)
        {
            if (id != barber.Id)
            {
                return NotFound();
